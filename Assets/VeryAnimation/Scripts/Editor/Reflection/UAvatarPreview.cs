            ...
            if (Event.current.type == EventType.Repaint)
            {
...

                {
                    ...
                    if (!clip.legacy && animator != null && animator.runtimeAnimatorController != null)
                    {
                        ...
                        animator.Play(0, 0, animationClipSettings.stopTime - animationClipSettings.startTime == 0.0 ? 0.0f : (float)((uTimeControl.currentTime - animationClipSettings.startTime) / (animationClipSettings.stopTime - animationClipSettings.startTime)));
