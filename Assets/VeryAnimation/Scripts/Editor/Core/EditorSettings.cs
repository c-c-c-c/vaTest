            ...
            EditorGUILayout.BeginVertical(GUI.skin.box);
            {
                ...
                if (extraFoldout)
                {
                    EditorGUI.indentLevel++;
                    {
                        ...
                        {
                            EditorGUI.BeginChangeCheck();
                            settingExtraSynchronizeAnimation = EditorGUILayout.Toggle(Language.GetContent(Language.Help.SettingsSynchronizeAnimation), settingExtraSynchronizeAnimation);
                            if (EditorGUI.EndChangeCheck())
                            {
