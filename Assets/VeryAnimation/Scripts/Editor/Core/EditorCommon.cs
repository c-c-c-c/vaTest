...
namespace VeryAnimation
{
    public class EditorCommon
    {
        ...
        public static bool Ray_Triangle(ref Ray ray, ref Vector3 v0, ref Vector3 v1, ref Vector3 v2, out Vector3 resultP)
        {
            var e1 = v1 - v0;
            var e2 = v2 - v0;
        ...
        public static bool Ray_TriangleBoth(ref Ray ray, ref Vector3 v0, ref Vector3 v1, ref Vector3 v2, out Vector3 resultP)
        {
            var e1 = v1 - v0;
            var e2 = v2 - v0;
